...
CREATE TABLE `tbl_section` (
  ...
  CONSTRAINT `fk_section_course` FOREIGN KEY (`course_id`) REFERENCES `tbl_course` (`course_id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `tbl_section` VALUES (2,'BSIT-A1','1st year',3),(3,'BSIT-B1','1st year',3),(4,'CS-C1','1st year',5);
