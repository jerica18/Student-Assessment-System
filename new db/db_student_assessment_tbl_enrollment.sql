...
CREATE TABLE `tbl_enrollment` (
  ...
  CONSTRAINT `tbl_enrollment_ibfk_1` FOREIGN KEY (`assignment_id`) REFERENCES `tbl_assignment` (`assignment_id`),
  CONSTRAINT `tbl_enrollment_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `tbl_student` (`student_id`)
...
INSERT INTO `tbl_enrollment` VALUES (3,2,10003,'2026-01-03','Active'),(4,2,10004,'2026-01-04','Active'),(5,2,10005,'2026-01-05','Active');
