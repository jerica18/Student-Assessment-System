...
CREATE TABLE `tblemployee` (
  ...
  `Employee_Address` varchar(300) DEFAULT NULL,
  `Employee_Birthdate` date DEFAULT NULL,
  `Employee_Gender` varchar(100) DEFAULT NULL,
  `Employee_ContactNumber` varchar(100) DEFAULT NULL,
...
INSERT INTO `tblemployee` VALUES (1018,'CoE','castillo','karl','caro','manila','1990-12-11','Male','09873645364','karlcastillo@umindanao.edu.ph','Teacher'),(1020,'CAS','Han','Clarise','Adam','China','2001-09-12','Female','09675436547','Hanclaris@umindanao.edu.ph','Admin'),(1021,'CCS','Cloud','Clara','Zero','America','1990-12-10','Female','09784567354','clarazero.tc@umindanao.edu.pd','Teacher');
